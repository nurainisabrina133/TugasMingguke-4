...
public class ExpensePage {
    ...
    By kategoriPulsa = By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[8]/android.widget.LinearLayout/android.widget.TextView");
    By kategori = By.id("com.chad.financialrecord:id/spCategory");
    ...
    public void setCategory(){
        ...
        driver.findElement(kategoriPulsa).click();
    }
